...
Figure 1 shows the time taken per query of latitude and longitude pairs in each of the 3 methods for queries generated in the Continental United States. Due to scaling factors, it can be noted from the associated minimum, average and maximum times, the difference between each method.
